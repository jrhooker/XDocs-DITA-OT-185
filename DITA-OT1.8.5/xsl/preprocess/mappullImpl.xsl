    ...
    <!--need to create these variables regardless, for passing as a parameter to get-stuff template-->
        ...
        <xsl:copy>
          ...
          <xsl:if test="not(@component)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">component</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@fw_package)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">fw_package</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@package)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">package</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@sas-ports)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">sas-ports</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@pcie-host-ports)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">pcie-host-ports</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@pcie-drive-ports)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">pcie-drive-ports</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@ddr-width)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">ddr-width</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@raid-support)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">raid-support</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@pmc_phy)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">pmc_phy</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@pmc_switch)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">pmc_switch</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@pmc_package)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">pmc_package</xsl:with-param></xsl:apply-templates>
          </xsl:if>
          <xsl:if test="not(@media)">
            <xsl:apply-templates select="." mode="mappull:inherit-and-set-attribute"><xsl:with-param name="attrib">media</xsl:with-param></xsl:apply-templates>
          </xsl:if>
