...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:key name="omit-from-unordered-links" match="*[@importance='required' and (not(@role) or @role='sibling' or @role='friend' or @role='cousin')]" use="1" use-when="starts-with(system-property('DOT_VERSION'), '2.')"/>
  ...
  <xsl:template match="*[contains(@class,' topic/related-links ')]" name="topic.related-links" use-when="not(starts-with(system-property('DOT_VERSION'), '2.'))">
    <div>
  ...
  <!--main template for setting up all links after the body - applied to the related-links container-->
  <xsl:template match="*[contains(@class, ' topic/related-links ')]" name="topic.related-links" use-when="starts-with(system-property('DOT_VERSION'), '2.')">
    <nav role="navigation">
      <xsl:call-template name="commonattributes"/>
  ...
  <xsl:template name="parsehref" use-when="starts-with(system-property('DOT_VERSION'), '2.')">
		<xsl:param name="href"/>
		<xsl:choose>
