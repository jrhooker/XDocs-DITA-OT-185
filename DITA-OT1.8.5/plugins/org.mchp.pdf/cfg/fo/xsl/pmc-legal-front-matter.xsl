...
--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:opentopic="http://www.idiominc.com/opentopic" exclude-result-prefixes="opentopic" version="2.0">
    ...
    <xsl:template name="createPMCLegalFrontMatter">
        <fo:page-sequence master-reference="front-matter" format="i">          
            <fo:flow flow-name="xsl-region-body">
                <fo:block font-size="30pt" font-weight="bold">
                    createPMCLegalFrontMatter
                    <!-- set the title -->
                              </fo:block>       
                <fo:block font-size="9pt" font-weight="bold">
                  
                 <xsl:apply-templates select="//*[contains(@class,' topic/topic ')][ancestor::*[contains(@class,' bookmap/preface ')]]"/>
