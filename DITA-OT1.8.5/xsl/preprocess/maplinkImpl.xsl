  ...
  <xsl:template mode="link" 
    ...
    <xsl:if 
      ...
      <link class="- topic/link ">
        ...
        <xsl:copy-of 
          select="@type|@scope|@importance|@format|@platform|@product|@audience|@otherprops|@component|@rev|@fw_package|@package|@sas-ports|@pcie-host-ports|@pcie-drive-ports|@ddr-width|@raid-support|@pmc_phy|@pmc_switch|@pmc_package|@media|@xtrf|@xtrc"/>        
