...
<!ENTITY % filter-atts
            'props      CDATA                              #IMPLIED
             ...
             media      CDATA                        #IMPLIED
             pmc_phy      CDATA                        #IMPLIED
             pmc_switch      CDATA                        #IMPLIED
             pmc_package      CDATA                        #IMPLIED
             ddr-width      CDATA                        #IMPLIED
             package      CDATA                        #IMPLIED
             fw_package      CDATA                        #IMPLIED
             pcie-drive-ports      CDATA                        #IMPLIED
             pcie-host-ports      CDATA                        #IMPLIED
             raid-support      CDATA                        #IMPLIED
             sas-ports      CDATA                        #IMPLIED
              stupid      CDATA                        #IMPLIED
