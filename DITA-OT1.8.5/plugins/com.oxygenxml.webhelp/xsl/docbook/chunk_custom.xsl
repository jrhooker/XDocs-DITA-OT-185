            ...
            <xsl:choose>
                <xsl:when test="(string-length($WEBHELP_FOOTER_FILE) = 0) 
                    ...
                    <div class="footer" xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <a class="oxyFooter" href="http://www.oxygenxml.com" target="_blank">
...
body { background-image: url('</xsl:text>
   ...
   /* background-position: center center; */
    ...
    <xsl:template match="d:itemizedlist" xmlns:d="http://docbook.org/ns/docbook" xmlns:svg="http://www.w3.org/2000/svg">
       ...
       of the deprecated HTML compact attribute -->
        ...
        <xsl:variable name="style.value"></xsl:variable>
        <div>
