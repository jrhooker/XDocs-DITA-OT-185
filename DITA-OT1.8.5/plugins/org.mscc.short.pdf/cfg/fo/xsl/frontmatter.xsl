...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="SHOWCOMMENTS-NUM" select="1"/>
    ...
    <xsl:template name="createFrontMatter_1.0">        
        <fo:page-sequence master-reference="body-first" format="1" initial-page-number="1"
                ...
                <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" margin-top="2pc">
                    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" font-weight="bold"
                        ...
                        <xsl:call-template name="insertVariable">
                            <xsl:with-param name="theVariableID"  select="'PMCDetailedRevisionHistory'"/>
                        </xsl:call-template>
                    </fo:block>
                            ...
                            <fo:table-row keep-with-next.within-column="always"
                                ...
                                <fo:table-cell padding-left="2pt" padding-right="2pt"
                                    ...
                                    <fo:block font-family="{$body.font.family}"
                                        font-size="{$body.font.size.small}">
                                        <xsl:call-template name="insertVariable">
                                            <xsl:with-param name="theVariableID"  select="'PMCIssueDate'"/>
                                        </xsl:call-template>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding-left="2pt" padding-right="2pt"
                                    ...
                                    <fo:block font-family="{$body.font.family}"
                                        font-size="{$body.font.size.small}">
                                        <xsl:call-template name="insertVariable">
                                            <xsl:with-param name="theVariableID"  select="'PMCPreparedBy'"/>
                                        </xsl:call-template>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding-left="2pt" padding-right="2pt"
                                    ...
                                    <fo:block font-family="{$body.font.family}"
                                        font-size="{$body.font.size.small}">
                                        <xsl:call-template name="insertVariable">
                                            <xsl:with-param name="theVariableID"  select="'PMCDetailsOfChange'"
                                            />
                                        </xsl:call-template>
                                    </fo:block>
                                </fo:table-cell>
                                    ...
                                    <xsl:for-each select="$pmc_iso[1]/pmc_revhistory/pmc_revision">
                                        <fo:table-row>
                                            ...
                                            <fo:table-cell padding-left="2pt" padding-right="2pt"
                                                ...
                                                border-right-style="solid"
                                                border-right-color="{$table.rule.color}"
                                                text-align="left" font-size="{$body.font.size.small}">
    ...
    <xsl:template name="createRevisionHistory">
        ...
        <xsl:choose>
            <xsl:when test="//topic[descendant::pmc-revhistory]"><fo:block> </fo:block></xsl:when>
            <xsl:when test="$pmc_iso[1]/pmc_revhistory/pmc_revision">
                                    ...
                                    <xsl:when test="@role='external' or @otherprops='external'">
                                        <fo:table-row>
                                            ...
                                            <fo:table-cell padding-left="2pt" padding-right="2pt"
                                                ...
                                                border-bottom-color="{$table.rule.color}"
                                                font-family="{$body.font.family}"
                                                font-size="{$body.font.size.small}" text-align="left">
                                                <xsl:apply-templates select="pmc_revdescription"
    ...
    <xsl:template name="createCoverPage">
        ...
        <fo:block xmlns:rx="http://www.renderx.com/XSL/Extensions"
            ...
            space-after.maximum="2em" keep-together.within-column="always" hyphenate="false">
            ...
            <xsl:if test="string-length(normalize-space($pmc_iso[1]/pmc_productname[1])) &gt; 1">
                <xsl:for-each select="$pmc_iso[1]/pmc_productname">
                    <fo:block text-align="right" font-family="{$title.font.family}" font-size="18pt"
                        space-before="5pt" font-weight="bold">
                        <xsl:value-of select="."/>
                    </fo:block>
                </xsl:for-each>
            </xsl:if>
            <xsl:if test="string-length(normalize-space($pmc_iso[1]/pmc_productnumber[1])) &gt; 1">
            ...
            <xsl:choose>
                <xsl:when test="$pmc_iso[1]/pmc_title[@otherprops = 'titlepage']">
                    <fo:block text-align="right" font-family="{$title.font.family}" font-size="20pt"
                        space-before="5pt" font-weight="bold">
                        <xsl:value-of select="$pmc_iso[1]/pmc_title[1]/text()"/>
                    </fo:block>
                </xsl:when>
                <xsl:when test="string-length(normalize-space($pmc_iso[1]/subtitle[1])) &gt; 1">
                    <fo:block text-align="right" font-family="{$title.font.family}" font-size="20pt"
                        space-before="5pt" font-weight="bold">
            ...
            <fo:block text-align="right" font-family="{$title.font.family}" font-size="12pt"
                ...
                <xsl:choose>
                    <xsl:when
                        ...
                        <xsl:if
                            test="string-length(normalize-space($pmc_iso[1]/issuenum[1])) &gt; 1 or string-length(normalize-space($pmc_iso[1]/pmc_issuenum)) &gt; 1">
                            <xsl:text> </xsl:text>
                            <xsl:call-template name="insertVariable">
                                <xsl:with-param name="theVariableID"  select="'PMCIssueNumber'"/>
                            </xsl:call-template>
                            <xsl:text> </xsl:text>
                            <xsl:value-of select="$pmc_iso[1]/issuenum | $pmc_iso[1]/pmc_issuenum"/>
                        </xsl:if>
                        <xsl:if
                            test="((string-length(normalize-space($pmc_iso[1]/issuenum[1])) &gt; 1) or (string-length(normalize-space($pmc_iso[1]/pmc_issuenum[1])) &gt; 1))                              and ((string-length(normalize-space($pmc_iso[1]/pubdate[1])) &gt; 1) or (string-length(normalize-space($pmc_iso[1]/pmc_issue_date[1])) &gt; 1))"
                            >: </xsl:if>
                    ...
                    <xsl:otherwise>
                        <xsl:if
                            test="(string-length(normalize-space($pmc_iso[1]/issuenum[1])) &gt; 1) or (string-length(normalize-space($pmc_iso[1]/pmc_issuenum[1])) &gt; 1)">
                            <xsl:call-template name="insertVariable">
                                <xsl:with-param name="theVariableID"  select="'PMCIssueNumber'"/>
                            </xsl:call-template>
                            <xsl:text> </xsl:text><xsl:value-of
                                select="$pmc_iso[1]/issuenum[1]/text() | $pmc_iso[1]/pmc_issuenum[1]/text()"
                            /></xsl:if>
                        <xsl:if
                            test="(string-length(normalize-space($pmc_iso[1]/issuenum[1])) &gt; 1) or (string-length(normalize-space($pmc_iso[1]/pmc_issuenum[1])) &gt; 1)"
                            >: </xsl:if>
