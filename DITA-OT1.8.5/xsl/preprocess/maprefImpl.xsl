...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:variable name="special-atts"
 select="' href class linking toc print audience product platform otherprops rev props component fw_package package sas-ports pcie-host-ports pcie-drive-ports ddr-width raid-support pmc_phy pmc_switch pmc_package media '"/>
    ...
    <xsl:template match="*[contains(@class, ' map/topicref ')]" priority="10">
        ...
        <xsl:param name="parent-component">#none#</xsl:param>
       
        <xsl:param name="parent-fw_package">#none#</xsl:param>
        <xsl:param name="parent-package">#none#</xsl:param>
        <xsl:param name="parent-sas-ports">#none#</xsl:param>
        <xsl:param name="parent-pcie-host-ports">#none#</xsl:param>
        <xsl:param name="parent-pcie-drive-ports">#none#</xsl:param>
        <xsl:param name="parent-ddr-width">#none#</xsl:param>
        <xsl:param name="parent-raid-support">#none#</xsl:param>
        <xsl:param name="parent-pmc_phy">#none#</xsl:param>
        <xsl:param name="parent-pmc_switch">#none#</xsl:param>
        <xsl:param name="parent-pmc_package">#none#</xsl:param>
        <xsl:param name="parent-media">#none#</xsl:param>
 ...
 select="translate($fileurl-origin,'\','/')"/>
                </xsl:call-template>
              </xsl:variable>
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="not($file) or not($file/*/*)">
                        <xsl:call-template name="output-message">
                            ...
                            <xsl:with-param name="msgsev">E</xsl:with-param>
                            <xsl:with-param name="msgparams">%1=<xsl:value-of select="$filename"
                                /></xsl:with-param>
                        </xsl:call-template>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when
 test="not(contains(@href,'://') or $element-id='#none#' or
                                                $file/*[contains(@class,' map/map ')][@id = $element-id])">
                                <!-- reference to an element -->
                                <xsl:apply-templates
 select="$file//*[contains(@class,' map/topicref ')][@id=$element-id]">
                                    ...
                                    <xsl:with-param name="relative-path">
                                        <xsl:choose>
                                            <xsl:when
 test="not($relative-path='#none#' or $relative-path='')">
 ...
 select="@href"/>
                                    ...
                                    <xsl:with-param name="parent-pmc_switch">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-pmc_switch='#none#')">
                                                <xsl:value-of select="$parent-pmc_switch"/>
                                            </xsl:when>
                                            <xsl:when test="@pmc_switch and not(@pmc_switch='')">
                                                <xsl:value-of select="@pmc_switch"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>
                                    ...
                                    <xsl:with-param name="parent-component">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-component='#none#')">
                                                <xsl:value-of select="$parent-otherprops"/>
                                            </xsl:when>
                                            <xsl:when test="@component and not(@component='')">
                                                <xsl:value-of select="@component"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>                                   
                                    <xsl:with-param name="parent-fw_package">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-fw_package='#none#')">
                                                <xsl:value-of select="$parent-fw_package"/>
                                            </xsl:when>
                                            <xsl:when test="@fw_package and not(@fw_package='')">
                                                <xsl:value-of select="@fw_package"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>
                                    <xsl:with-param name="parent-package">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-package='#none#')">
                                                <xsl:value-of select="$parent-package"/>
                                            </xsl:when>
                                            <xsl:when test="@package and not(@package='')">
                                                <xsl:value-of select="@package"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>
                                    <xsl:with-param name="parent-sas-ports">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-sas-ports='#none#')">
                                                <xsl:value-of select="$parent-sas-ports"/>
                                            </xsl:when>
                                            <xsl:when test="@sas-ports and not(@sas-ports='')">
                                                <xsl:value-of select="@sas-ports"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>
                                    <xsl:with-param name="parent-pcie-host-ports">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-pcie-host-ports='#none#')">
                                                <xsl:value-of select="$parent-pcie-host-ports"/>
                                            </xsl:when>
                                            <xsl:when
                                                test="@pcie-host-ports and not(@pcie-host-ports='')">
                                                <xsl:value-of select="@pcie-host-ports"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>
                                    <xsl:with-param name="parent-pcie-drive-ports">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-pcie-drive-ports='#none#')">
                                                <xsl:value-of select="$parent-pcie-drive-ports"/>
                                            </xsl:when>
                                            <xsl:when
                                                test="@pcie-drive-ports and not(@pcie-drive-ports='')">
                                                <xsl:value-of select="@pcie-drive-ports"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>
                                    <xsl:with-param name="parent-ddr-width">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-ddr-width='#none#')">
                                                <xsl:value-of select="$parent-ddr-width"/>
                                            </xsl:when>
                                            <xsl:when test="@ddr-width and not(@ddr-width='')">
                                                <xsl:value-of select="@ddr-width"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>
                                    <xsl:with-param name="parent-raid-support">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-raid-support='#none#')">
                                                <xsl:value-of select="$parent-raid-support"/>
                                            </xsl:when>
                                            <xsl:when test="@raid-support and not(@raid-support='')">
                                                <xsl:value-of select="@raid-support"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>
                                    <xsl:with-param name="parent-pmc_phy">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-pmc_phy='#none#')">
                                                <xsl:value-of select="$parent-pmc_phy"/>
                                            </xsl:when>
                                            <xsl:when test="@pmc_phy and not(@pmc_phy='')">
                                                <xsl:value-of select="@pmc_phy"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>                                   
                                    <xsl:with-param name="parent-pmc_package">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-pmc_package='#none#')">
                                                <xsl:value-of select="$parent-pmc_package"/>
                                            </xsl:when>
                                            <xsl:when test="@pmc_package and not(@pmc_package='')">
                                                <xsl:value-of select="@pmc_package"/>
                                            </xsl:when>
                                            <xsl:otherwise>#none#</xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:with-param>
                                    <xsl:with-param name="parent-media">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-media='#none#')">
                                                <xsl:value-of select="$parent-media"/>
                                            </xsl:when>
                                            <xsl:when test="@media and not(@media='')">
                            ...
                            <xsl:otherwise>
                                ...
                                <xsl:apply-templates select="$file/*/*[contains(@class,' map/topicref ')] | $file/*/processing-instruction()">
                                    ...
                                    <xsl:with-param name="parent-component">
                                        <xsl:choose>
                                            <xsl:when test="not($parent-component='#none#')">
                                                <xsl:value-of select="$parent-component"/>
                                            </xsl:when>
                                            <xsl:when test="@component and not(@component='')">
                                                <xsl:value-of select="@component"/>
                                            </xsl:when>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@linking">
                                    <xsl:attribute name="linking">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@linking"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@toc">
                                    <xsl:attribute name="toc">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@toc"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@print">
                                    <xsl:attribute name="print">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@print"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@audience">
                                    <xsl:attribute name="audience">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@audience"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@component">
                                    <xsl:attribute name="component">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@component"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@component and not(@component='')">
                                <xsl:attribute name="component">
                                    <xsl:value-of select="@component"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@rev">
                                    <xsl:attribute name="rev">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@rev"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@fw_package">
                                    <xsl:attribute name="fw_package">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@fw_package"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@fw_package and not(@fw_package='')">
                                <xsl:attribute name="fw_package">
                                    <xsl:value-of select="@fw_package"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@package">
                                    <xsl:attribute name="package">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@package"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@sas-ports">
                                    <xsl:attribute name="sas-ports">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@sas-ports"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@sas-ports and not(@sas-ports='')">
                                <xsl:attribute name="sas-ports">
                                    <xsl:value-of select="@sas-ports"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                <xsl:when test="@pcie-host-ports and not(@pcie-host-ports='')">
                                    <xsl:attribute name="pcie-host-ports">
                                        <xsl:value-of select="@pcie-host-ports"/>
                                    </xsl:attribute>
                                </xsl:when>
                                <xsl:when test="not($parent-pcie-host-ports='#none#')">
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@pcie-host-ports">
                                    <xsl:attribute name="pcie-host-ports">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@pcie-host-ports"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@pcie-host-ports and not(@pcie-host-ports='')">
                                <xsl:attribute name="pcie-host-ports">
                                    <xsl:value-of select="@pcie-host-ports"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                <xsl:when test="@pcie-drive-ports and not(@pcie-drive-ports='')">
                                    <xsl:attribute name="pcie-drive-ports">
                                        <xsl:value-of select="@pcie-drive-ports"/>
                                    </xsl:attribute>
                                </xsl:when>
                                <xsl:when test="not($parent-pcie-drive-ports='#none#')">
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@pcie-drive-ports">
                                    <xsl:attribute name="pcie-drive-ports">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@pcie-drive-ports"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@pcie-drive-ports and not(@pcie-drive-ports='')">
                                <xsl:attribute name="pcie-drive-ports">
                                    <xsl:value-of select="@pcie-drive-ports"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@ddr-width">
                                    <xsl:attribute name="ddr-width">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@ddr-width"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@ddr-width and not(@ddr-width='')">
                                <xsl:attribute name="ddr-width">
                                    <xsl:value-of select="@ddr-width"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                <xsl:when test="@raid-support and not(@raid-support='')">
                                    <xsl:attribute name="raid-support">
                                        <xsl:value-of select="@raid-support"/>
                                    </xsl:attribute>
                                </xsl:when>
                                <xsl:when test="not($parent-raid-support='#none#')">
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@raid-support">
                                    <xsl:attribute name="raid-support">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@raid-support"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@raid-support and not(@raid-support='')">
                                <xsl:attribute name="raid-support">
                                    <xsl:value-of select="@raid-support"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@pmc_phy">
                                    <xsl:attribute name="pmc_phy">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@pmc_phy"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@pmc_phy and not(@pmc_phy='')">
                                <xsl:attribute name="pmc_phy">
                                    <xsl:value-of select="@pmc_phy"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@pmc_switch">
                                    <xsl:attribute name="pmc_switch">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@pmc_switch"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@pmc_switch and not(@pmc_switch='')">
                                <xsl:attribute name="pmc_switch">
                                    <xsl:value-of select="@pmc_switch"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                <xsl:when test="@pmc_package and not(@pmc_package='')">
                                    <xsl:attribute name="pmc_package">
                                        <xsl:value-of select="@pmc_package"/>
                                    </xsl:attribute>
                                </xsl:when>
                                <xsl:when test="not($parent-pmc_package='#none#')">
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@pmc_package">
                                    <xsl:attribute name="pmc_package">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@pmc_package"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@pmc_package and not(@pmc_package='')">
                                <xsl:attribute name="pmc_package">
                                    <xsl:value-of select="@pmc_package"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
                                    test="ancestor-or-self::*[contains(@class, ' map/map ')]/@media">
                                    <xsl:attribute name="media">
                                        <xsl:value-of
                                            select="ancestor-or-self::*[contains(@class, ' map/map ')]/@media"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:if test="@media and not(@media='')">
                                <xsl:attribute name="media">
                                    <xsl:value-of select="@media"/>
                                </xsl:attribute>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@product">
                                    <xsl:attribute name="product">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@product"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@platform">
                                    <xsl:attribute name="platform">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@platform"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@otherprops">
                                    <xsl:attribute name="otherprops">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@otherprops"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@props">
                                    <xsl:attribute name="props">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@props"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@processing-role">
                                    <xsl:attribute name="processing-role">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@processing-role"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@importance">
                                    <xsl:attribute name="importance">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@importance"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="$referTypeFlag = 'file'">
                            <xsl:choose>
                                ...
                                <xsl:when
 test="ancestor-or-self::*[contains(@class, ' map/map ')]/@search">
                                    <xsl:attribute name="search">
                                        <xsl:value-of
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@search"
                                        />
                                    </xsl:attribute>
                                </xsl:when>
                            </xsl:choose>
 ...
 select="ancestor-or-self::*[contains(@class, ' map/map ')]/@rev"
                    ...
                    <xsl:apply-templates
 select="*|@*[not(contains($special-atts,concat(' ',local-name(),' ')))]|comment()|text()|processing-instruction()">
        ...
        <xsl:template match="*[contains(@class,' map/topicref ')]" mode="mapref">
            ...
            <xsl:choose>
                ...
                <xsl:when test="not($linking='none') and @href and not(contains(@href,'#'))">
                    <xsl:variable name="update-id-path"
 select="concat($mapref-id-path,' ',generate-id(.),' ')"/>
 ...
 mode="mapref">
        ...
        <xsl:template match="@href" mode="reltable-copy">
            ...
            <xsl:attribute name="href">
                <xsl:choose>
                    <xsl:when
 test="not(contains(.,'://') or ../@scope='external' or $relative-path='#none#' or $relative-path='')">
 ...
 mode="mappull:inherit-one-level">
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:apply-templates
 select="ancestor::*[contains(@class, ' map/reltable ')]"
