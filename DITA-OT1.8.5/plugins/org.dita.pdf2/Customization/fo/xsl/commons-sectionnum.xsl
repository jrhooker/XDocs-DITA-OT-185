...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:key name="map-id" match="*[contains(@class, ' topic/topic ')][@id]" use="@id"/>   
  ...
  <xsl:template match="*[contains(@class, ' topic/tbody ')]/*[contains(@class, ' m-software-d/field ')]/*[contains(@class, ' m-software-d/field-type ')]">
    ...
    <xsl:template match="*" mode="getTitle">
        <xsl:variable name="topic" select="ancestor-or-self::*[contains(@class, ' topic/topic ')]"/>
    ...
    <xsl:template
        match="*[contains(@class, ' bookmap/chapter ')] | *[contains(@class, ' topic/topic ')][not(ancestor-or-self::*[contains(@class,' bookmap/frontmatter ')])]"
        mode="topicTitleNumber" priority="1">
        <xsl:number format="1"
            count="*[contains(@class, ' topic/topic ')][not(ancestor-or-self::*[contains(@class,' bookmap/frontmatter ')])] | *[contains(@class, ' bookmap/chapter ')]"
            level="multiple"/>
    </xsl:template>

    <xsl:template
        match="*[contains(@class, ' topic/topic ')][not(ancestor-or-self::*[contains(@class,' bookmap/frontmatter ')])][ancestor-or-self::*[contains(@class, ' bookmap/appendix ')]]"
        mode="topicTitleNumber" priority="2">
        <xsl:number format="A.1"
            count="*[contains(@class, ' topic/topic ')][not(ancestor-or-self::*[contains(@class,' bookmap/frontmatter ')])][ancestor-or-self::*[contains(@class, ' bookmap/appendix ')]]"
            level="multiple"/>
    </xsl:template>
