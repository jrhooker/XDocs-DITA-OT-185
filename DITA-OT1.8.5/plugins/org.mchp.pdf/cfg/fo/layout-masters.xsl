...
<fo:simple-page-master master-name="front-matter-first" xsl:use-attribute-sets="frontmatter-page-master">
...
<fo:simple-page-master master-name="front-matter-last" xsl:use-attribute-sets="frontmatter-page-master">
...
<fo:simple-page-master master-name="front-matter-even" xsl:use-attribute-sets="frontmatter-page-master">
<fo:region-body xsl:use-attribute-sets="region-body__frontmatter.even"/>
...
<fo:simple-page-master master-name="front-matter-odd" xsl:use-attribute-sets="frontmatter-page-master">
<fo:region-body xsl:use-attribute-sets="region-body__frontmatter.odd"/>
<fo:region-before region-name="odd-frontmatter-header" xsl:use-attribute-sets="region-before"/>
<fo:region-after region-name="odd-frontmatter-footer" xsl:use-attribute-sets="region-after"/>
</fo:simple-page-master>

<!-- Coverpage simple masters -->

<fo:simple-page-master master-name="coverpage-first" xsl:use-attribute-sets="coverpage-master">
    <fo:region-body xsl:use-attribute-sets="region-body__coverpage"/>
<fo:region-before region-name="coverpage-header" xsl:use-attribute-sets="region-before__coverpage"/>
<fo:region-after region-name="coverpage-footer" xsl:use-attribute-sets="region-after__coverpage"/>
</fo:simple-page-master>


<fo:simple-page-master master-name="coverpage-odd" xsl:use-attribute-sets="coverpage-master">
    <fo:region-body xsl:use-attribute-sets="region-body.odd"/>
<fo:region-before region-name="coverpage-header" xsl:use-attribute-sets="region-before__coverpage"/>
<fo:region-after region-name="coverpage-footer" xsl:use-attribute-sets="region-after__coverpage"/>
</fo:simple-page-master>

<fo:simple-page-master master-name="coverpage-even" xsl:use-attribute-sets="coverpage-master">
    <fo:region-body xsl:use-attribute-sets="region-body.odd"/>
<fo:region-before region-name="coverpage-header" xsl:use-attribute-sets="region-before__coverpage"/>
<fo:region-after region-name="coverpage-footer" xsl:use-attribute-sets="region-after__coverpage"/>
</fo:simple-page-master>

<fo:simple-page-master master-name="coverpage-last" xsl:use-attribute-sets="coverpage-master">
    <fo:region-body xsl:use-attribute-sets="region-body.odd"/>
<fo:region-before region-name="coverpage-header" xsl:use-attribute-sets="region-before__coverpage"/>
<fo:region-after region-name="coverpage-footer" xsl:use-attribute-sets="region-after__coverpage"/>
</fo:simple-page-master>
...
<!--TOC simple masters-->
<xsl:if test="$mirror-page-margins">
<fo:simple-page-master master-name="toc-even" xsl:use-attribute-sets="toc-page-master">
<fo:region-body xsl:use-attribute-sets="toc-body.even"/>
...
<fo:simple-page-master master-name="toc-odd" xsl:use-attribute-sets="toc-page-master">
<fo:region-body xsl:use-attribute-sets="toc-body.odd"/>
...
<fo:simple-page-master master-name="toc-last" xsl:use-attribute-sets="toc-page-master">
<fo:region-body xsl:use-attribute-sets="toc-body.even"/>
<fo:region-before region-name="even-toc-header" xsl:use-attribute-sets="region-before"/>
<fo:region-after region-name="even-toc-footer" xsl:use-attribute-sets="region-after"/>
</fo:simple-page-master>

<fo:simple-page-master master-name="toc-first" xsl:use-attribute-sets="toc-page-master">
<fo:region-body xsl:use-attribute-sets="toc-body.odd"/>
<fo:region-before region-name="odd-toc-header" xsl:use-attribute-sets="region-before"/>
<fo:region-after region-name="odd-toc-footer" xsl:use-attribute-sets="region-after"/>
</fo:simple-page-master>
...
<fo:region-body xsl:use-attribute-sets="region-body.odd"/>
<fo:region-before region-name="last-body-header" xsl:use-attribute-sets="legal.region-before"/>
<fo:region-after region-name="last-body-footer" xsl:use-attribute-sets="legal.region-after"/>
</fo:simple-page-master>

<!--LEGAL simple masters-->

<fo:simple-page-master master-name="legal-first" xsl:use-attribute-sets="frontmatter-page-master">
<fo:region-body xsl:use-attribute-sets="region-body__frontmatter.odd"/>
<fo:region-before region-name="odd-legal-header" xsl:use-attribute-sets="legal.region-before"/>
<fo:region-after region-name="odd-legal-footer" xsl:use-attribute-sets="legal.region-after"/>
</fo:simple-page-master>

<xsl:if test="$mirror-page-margins">
<fo:simple-page-master master-name="legal-even" xsl:use-attribute-sets="simple-page-master">
<fo:region-body xsl:use-attribute-sets="region-body__frontmatter.odd"/>
<fo:region-before region-name="odd-legal-header" xsl:use-attribute-sets="legal.region-before"/>
<fo:region-after region-name="odd-legal-footer" xsl:use-attribute-sets="legal.region-after"/>
</fo:simple-page-master>
...
<fo:simple-page-master master-name="legal-odd" xsl:use-attribute-sets="simple-page-master">
<fo:region-body xsl:use-attribute-sets="region-body__frontmatter.odd"/>
<fo:region-before region-name="odd-legal-header" xsl:use-attribute-sets="legal.region-before"/>
<fo:region-after region-name="odd-legal-footer" xsl:use-attribute-sets="legal.region-after"/>
</fo:simple-page-master>

<fo:simple-page-master master-name="legal-last" xsl:use-attribute-sets="simple-page-master">
<fo:region-body xsl:use-attribute-sets="region-body__frontmatter.odd"/>
<fo:region-before region-name="last-body-header" xsl:use-attribute-sets="legal.region-before"/>
<fo:region-after region-name="last-body-footer" xsl:use-attribute-sets="legal.region-after"/>
</fo:simple-page-master>
...
<xsl:call-template name="generate-page-sequence-master">
<xsl:with-param name="master-name" select="'coverpage'"/>
...
<xsl:if test="$first">
<fo:conditional-page-master-reference master-reference="{$master-reference}-first" odd-or-even="odd"
page-position="first"/>
</xsl:if>
<xsl:if test="$last">
<fo:conditional-page-master-reference master-reference="{$master-reference}-last" odd-or-even="even"
page-position="last"/>
<!--blank-or-not-blank="blank"-->
</xsl:if>
<xsl:choose>
<xsl:when test="$mirror-page-margins">
<fo:conditional-page-master-reference master-reference="{$master-reference}-odd" odd-or-even="odd"/>
<fo:conditional-page-master-reference master-reference="{$master-reference}-even" odd-or-even="even"
/>
</xsl:when>
<xsl:otherwise>
