  ...
  <xsl:if test="normalize-space($FILTERFILEURL)!=''">
    <xsl:if test="@audience">
      <xsl:call-template name="gen-prop">
        ...
        <xsl:if test="@pmc_switch">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'pmc_switch'"/>
        <xsl:with-param name="flag-att-val" select="@pmc_switch"/>
      </xsl:call-template>
    </xsl:if>
    ...
    <xsl:if test="@component">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'component'"/>
        <xsl:with-param name="flag-att-val" select="@component"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="@fw_package">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'fw_package'"/>
        <xsl:with-param name="flag-att-val" select="@fw_package"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="@package">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'package'"/>
        <xsl:with-param name="flag-att-val" select="@package"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="@sas-ports">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'sas-ports'"/>
        <xsl:with-param name="flag-att-val" select="@sas-ports"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="@pcie-host-ports">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'pcie-host-ports'"/>
        <xsl:with-param name="flag-att-val" select="@pcie-host-ports"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="@pcie-drive-ports">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'pcie-drive-ports'"/>
        <xsl:with-param name="flag-att-val" select="@pcie-drive-ports"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="@ddr-width">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'ddr-width'"/>
        <xsl:with-param name="flag-att-val" select="@ddr-width"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="@raid-support">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'raid-support'"/>
        <xsl:with-param name="flag-att-val" select="@raid-support"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="@pmc_phy">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'pmc_phy'"/>
        <xsl:with-param name="flag-att-val" select="@pmc_phy"/>
      </xsl:call-template>
    </xsl:if>
    
 
    
    <xsl:if test="@pmc_package">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'pmc_package'"/>
        <xsl:with-param name="flag-att-val" select="@pmc_package"/>
      </xsl:call-template>
    </xsl:if>
    
    <xsl:if test="@media">
      <xsl:call-template name="gen-prop">
        <xsl:with-param name="flag-att" select="'media'"/>
        <xsl:with-param name="flag-att-val" select="@media"/>
      </xsl:call-template>
    </xsl:if>
