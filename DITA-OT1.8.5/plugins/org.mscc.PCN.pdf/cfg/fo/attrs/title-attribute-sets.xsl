...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    version="2.0">
    <xsl:attribute-set name="topic.title.nonum" use-attribute-sets="topic.title">        
    ...
    <xsl:attribute-set name="book-title-header-w-subtitle">        
        <xsl:attribute name="font-family">
            <xsl:value-of select="$title.font.family"/>
        </xsl:attribute>
    ...
    <xsl:attribute-set name="book-title-header">        
        <xsl:attribute name="font-family">
            <xsl:value-of select="$title.font.family"/>
        </xsl:attribute>
    ...
    <xsl:attribute-set name="book-subtitle-header">        
        <xsl:attribute name="font-family">
            <xsl:value-of select="$title.font.family"/>
        </xsl:attribute>
