...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="topicTitle.numLevel" select="0"/>
  ...
  <xsl:variable name="page-margin-inside">2.5cm</xsl:variable>
  ...
  <xsl:variable name="page-margin-inside-frontmatter">2.5cm</xsl:variable>
  ...
  <xsl:param name="header.font.size">10pt</xsl:param>
  ...
  <xsl:param name="title.font.color">#000066</xsl:param>
  <xsl:param name="title.border.font.color">#ccccff</xsl:param>
  <xsl:param name="minor.title.font.color">#000066</xsl:param>
  ...
  <xsl:param name="table.header.background.color">#eeeeee</xsl:param>
  <xsl:param name="table.cell.border.color">#ffffff</xsl:param>
  <xsl:param name="table.frame.border.thickness">thin</xsl:param>
